...
private:
    /// @brief The optimal actions for any hand with a hard total. The rows (first indices)
    /// represent the player's hard total, while the columns represent the dealer's upcard
    /// (2-10, then ace; face cards count as 10).
